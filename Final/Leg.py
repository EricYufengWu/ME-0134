...
class Leg:
    def __init__(self, rotate, knee, ankle, width = 41.9, length = 22, coxia = 19.1, femur = 120.6, tibia = 202, x0 = 50, y0 = 100, z0 = 50):
    ...
    def inverse_k(self, x_offs=0, y_offs=0, z_offs=0):
        ...
        try:
            ...
            self.joints[0].goAng = math.fabs(math.degrees(theta_c)) 
            self.joints[1].goAng = math.fabs(math.degrees(theta_f)) 
            self.joints[2].goAng = math.fabs(math.degrees(theta_t))
